...
```json
{
    ...
    "data": {
        ...
        "promotions": [
            ...
            {
                "promotion_name": "ซื้อกลุ่มสินค้าได้รับคอยน์",
...
| `discount_bill` | Number | Bill-level discount applied to the order. |
...
| `coupon_discount` | Number | Discount amount from coupon code. |
| `bill_discount` | Number | Discount applied at the bill level. |
| `promotion_bill_discount` | Number | Discount from bill-level promotions. |
| `manual_bill_discount` | Number | Manually applied bill-level discount. |
| `campaign_discount` | Number | Discount from campaign promotions. |
| `point_discount` | Number | Discount redeemed using loyalty points. |
| `coin_discount` | Number | Discount redeemed using coins. |
...
| `point_gain` | Number | Loyalty points earned from this promotion. |
| `coin_gain` | Number | Coins earned from this promotion. |
